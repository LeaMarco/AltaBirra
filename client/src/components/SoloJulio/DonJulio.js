window.addEventListener('dfMessengerLoaded', (evento) => {
    ...
    console.log('Aqui Esta Julio ', evento);

    const dfMessenger = document.querySelector('df-messenger'); // Elemento Bot

    dfMessenger.showMinChat('Acaba de cargar julio')
    ...
    // dfMessenger.renderCustomCard(payloadComands)
    ...
    dfMessenger.addEventListener('df-user-input-entered', (evento) => {
        ...
        switch (respuesta.toUpperCase()) {
            case "HOLA": {
                dfMessenger.renderCustomCard(payloadWelcome)
                break;
            }
            case "COMANDOS DE VER": {
                dfMessenger.renderCustomText(`Aqui tienes los comandos de \"Ver\" junto con su componente y para que sirven`)
                dfMessenger.renderCustomCard(payloadComands)
                break;
            }
            case "COMANDOS DE \"VER\"": {
            ...
            case "COMANDOS DE \"MOSTRAR COMPONENTES\"": {
                dfMessenger.renderCustomText("Proximamente comandos de \"Muestra de Componentes...\"")
                break;
            }
            case "COMANDOS DE MOSTRAR COMPONENTES": {
                dfMessenger.renderCustomText("Proximamente comandos de \"Muestra de Componentes...\"")
