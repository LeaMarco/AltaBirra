	...
	return (
		<div className={Style.container}>
			<div className={Style.subcontainer}>
				<input className={Style.categoryName} readOnly onClick={event => handleSearch(event)} value="Rubia" />
				<div>
					<h4> Informacion </h4>
			...
			<div className={Style.subcontainer}>
				<input className={Style.categoryName} readOnly onClick={event => handleSearch(event)} value="Roja" />
				<div>
					<h4> Informacion </h4>
			...
			<div className={Style.subcontainer}>
				<input className={Style.categoryName} readOnly onClick={event => handleSearch(event)} value="Negra" />
				<div>
					<h4> Informacion </h4>
